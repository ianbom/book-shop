...
export function HeroSection() {
    return (
        <section className="bg-foreground relative isolate min-h-[430px] overflow-hidden sm:min-h-[500px] lg:min-h-[560px]">
            <img
            ...
            <SectionContainer className="flex min-h-[430px] items-center py-16 sm:min-h-[500px] lg:min-h-[560px]">
                <div className="text-primary-foreground max-w-xl">
                    ...
                    <p className="text-primary-foreground/90 mt-6 max-w-md text-base leading-7 sm:text-lg">
                        Ribuan buku inspiratif menanti untuk menemani setiap
                        langkah perjalananmu.
                    </p>
                    <a
                        href="/books"
                        className="bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:outline-primary-foreground mt-8 inline-flex h-11 items-center gap-2 rounded-md px-5 text-sm font-semibold shadow-sm transition focus-visible:outline-2 focus-visible:outline-offset-2"
                    >
